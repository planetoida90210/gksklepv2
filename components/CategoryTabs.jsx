...
const CategoryTabs = ({categories, products}) => {
  ...
  return (
    <Tab.Group>
        <Tab.List className="flex justify-center">
          {
            ...
            <Tab
              ...
              id={category._id}
              className={({ selected }) =>
              `whitespace-nowrap rounded-t-lg py-3 px-5 text-sm font-light outline-none xl:py-4 xl:px-6 xl:text-base ${
              selected
        ...
        <Tab.Panels className="mx-auto max-w-fit pt-2 xl:pt-10 pb-24 sm:px-4">
